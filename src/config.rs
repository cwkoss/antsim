...
impl Default for SimConfig {
    fn default() -> Self {
        Self {
            ...
            evap_nest: 0.0005,      // OPTIMIZATION 2: Slower nest decay 
            evap_alarm: 0.01,
            ...
            follow_gain: 2.0,
            lay_rate_food: 20.0,    // OPTIMIZATION 2: Stronger pheromone laying
            lay_rate_nest: 25.0,    // OPTIMIZATION 2: Stronger nest pheromone
